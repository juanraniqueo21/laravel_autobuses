...
export default function Table({ 
  ...
  // Lógica para determinar si mostrar la columna extra de acciones
      ...
      <table className="w-full">
        <thead className="bg-gray-100 border-b border-gray-200">
          <tr>
            ...
            {/* CORRECCIÓN: Solo mostrar si se pasan funciones */}
            {showActions && (
          ...
          {data.length === 0 ? (
            ...
            data.map((row, idx) => (
              <tr key={idx} className="hover:bg-gray-100 transition-colors even:bg-gray-50">
                ...
                {/* CORRECCIÓN: Solo mostrar celda si se pasan funciones */}
                {showActions && (
