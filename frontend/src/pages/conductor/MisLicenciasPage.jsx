...
import {
  ...
  XCircle, Clock, Download, Edit, Calendar, File
} from 'lucide-react';
...
const MisLicenciasPage = () => {
  ...
  // Formateo de fecha (sin new Date)
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (isEditing) {
        ...
        setSuccess('Licencia solicitada con éxito');
      }
  ...
  const getEstadoBadge = (estado) => {
    switch (estado) {
      case 'solicitado':
        return (
          <span className="px-3 py-1 rounded-full text-xs font-bold uppercase bg-yellow-100 text-yellow-800 flex items-center gap-1">
            <Clock size={12} /> Solicitado
          </span>
        );
      case 'aprobado':
        return (
          <span className="px-3 py-1 rounded-full text-xs font-bold uppercase bg-green-100 text-green-800 flex items-center gap-1">
      ...
      default:
        return (
          <span className="px-3 py-1 rounded-full text-xs font-bold uppercase bg-gray-100 text-gray-800">
            {estado}
          </span>
        );
    }
    ...
    <div className="p-6 bg-gray-50 min-h-screen font-sans text-slate-800">
        ...
        <div className="relative z-10 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
          <div>
            ...
            <p className="mt-2 text-slate-300 max-w-xl">
              Historial y gestión de tus permisos y licencias médicas.
            </p>
          </div>
          <Button
            variant="primary"
      ...
      {licencias.length === 0 ? (
        <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-16 text-center">
          ...
          <p className="text-slate-500 mb-6">No tienes licencias registradas.</p>
                ...
                <div className="flex items-start gap-4 flex-1">
                  ...
                  <div>
                    <div className="flex items-center gap-3 mb-1">
                      <h3 className="font-bold text-lg">{getTipoLabel(lic.tipo)}</h3>
                    ...
                    <p className="text-sm text-slate-500 mt-3 italic bg-gray-50/50 p-3 rounded-lg">
                      "{lic.motivo}"
                    </p>

                    {lic.estado === 'rechazado' && lic.motivo_rechazo && (
                      <div className="mt-3 bg-red-50 border border-red-100 rounded-lg p-3 text-sm text-red-800 flex gap-2">
                        <AlertCircle size={16} />
                        <div>
          ...
          <div className="bg-white rounded-2xl shadow-2xl max-w-lg w-full max-h-[90vh] overflow-y-auto">
            ...
            <form onSubmit={handleSubmit} className="p-6 space-y-5">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label className="block text-sm font-bold mb-1.5">Inicio</label>
                  <input
                    type="date"
                    name="fecha_inicio"
                ...
                <div>
                  <label className="block text-sm font-bold mb-1.5">Término</label>
                  <input
                    type="date"
                    name="fecha_termino"
              ...
              <div>
                ...
                <div className="border-2 border-dashed border-gray-300 rounded-xl p-6 text-center relative group">
                  ...
                  <div className="pointer-events-none flex flex-col items-center gap-2">
                    <File size={32} className="text-slate-400 group-hover:text-blue-500" />
                    <p className="text-sm">
              ...
              <div>
                <label className="block text-sm font-bold mb-1.5">Motivo</label>
                <textarea
                  name="motivo"
